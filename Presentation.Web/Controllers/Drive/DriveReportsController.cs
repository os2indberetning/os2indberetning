...
namespace OS2Indberetning.Controllers
{
    public class DriveReportsController : BaseController<DriveReport>
    {
        ...
        public DriveReportsController(IGenericRepository<BankAccount> Bankrepo,IGenericRepository<OrgUnit> orgrepo, IGenericRepository<DriveReport> repo, IReportService<DriveReport> driveService, IGenericRepository<Person> personRepo, IGenericRepository<Employment> employmentRepo, ILogger logger)
